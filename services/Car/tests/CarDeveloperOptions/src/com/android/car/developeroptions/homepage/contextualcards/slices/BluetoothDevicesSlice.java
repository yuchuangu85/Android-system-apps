...
import com.android.car.developeroptions.bluetooth.BluetoothDeviceDetailsFragment;
...
public class BluetoothDevicesSlice implements CustomSliceable {
    ...
    /**
     * Refer {@link com.android.car.developeroptions.bluetooth.BluetoothDevicePreference#compareTo} to sort the
    ...
    List<CachedBluetoothDevice> getConnectedBluetoothDevices() {
        ...
        final LocalBluetoothManager bluetoothManager =
                com.android.car.developeroptions.bluetooth.Utils.getLocalBtManager(mContext);
