...
public abstract class SliderPreferenceController extends BasePreferenceController implements
    ...
    public void updateState(Preference preference) {
        if (preference instanceof com.android.car.developeroptions.widget.SeekBarPreference) {
            ((com.android.car.developeroptions.widget.SeekBarPreference) preference)
