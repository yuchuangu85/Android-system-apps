...
import static com.android.car.developeroptions.notification.SettingPref.TYPE_GLOBAL;
        ...
        mPreference = new SettingPref(
            ...
            public boolean isApplicable(Context context) {
                return context.getResources().getBoolean(
                    com.android.car.developeroptions.R.bool.has_dock_settings);
            }
                ...
                switch(value) {
                    case DOCK_AUDIO_MEDIA_DISABLED:
                        return res.getString(
                            com.android.car.developeroptions.R.string.dock_audio_media_disabled);
                    case DOCK_AUDIO_MEDIA_ENABLED:
                        return res.getString(
                            com.android.car.developeroptions.R.string.dock_audio_media_enabled);
                    default:
